...
<body class="landing-body">
    ...
    <header class="main-header" id="main-header">
        ...
        <div class="header-actions">
            <a href="<?php echo e(url('/login')); ?>" class="btn-nav-login">Iniciar Sesión</a>
            <a href="<?php echo e(url('/registro')); ?>" class="btn-nav-register">Crear Cuenta</a>
    ...
    <div class="mobile-menu" id="mobile-menu">
        ...
        <div class="mobile-actions">
            <a href="<?php echo e(url('/login')); ?>" class="btn-outline">Iniciar Sesión</a>
            <a href="<?php echo e(url('/registro')); ?>" class="btn-primary">Crear Cuenta</a>
        </div>
    </div>
    ...
    <main>
        ...
        <section id="urgencia" class="urgent-section">
            <div class="urgent-inner">
                ...
                <a class="btn-urgent" href="<?php echo e(route('guest.auxilio')); ?>">
        ...
        <section id="profesionales" class="benefits-section">
            <div class="benefits-grid">
                <div class="benefit-col patient-col">
                    ...
                    <a href="<?php echo e(url('/registro')); ?>" class="btn-primary">Comenzar como Paciente</a>
                </div>
                ...
                <div class="benefit-col psych-col">
                    ...
                    <a href="<?php echo e(url('/registro')); ?>" class="btn-outline dark">Unirme como Profesional</a>
                </div>
            </div>
        </section>
        ...
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <nav>
                    ...
                    <a href="<?php echo e(url('/registro')); ?>">Crear Cuenta</a>
                </nav>
            </div>
            ...
            <div class="footer-col">
                <h4>Profesionales</h4>
                <nav>
                    <a href="<?php echo e(url('/registro')); ?>">Unirse como Psicólogo</a>
            ...
            <div class="footer-col">
                <h4>Legal</h4>
                <nav>
                    <a href="<?php echo e(url('/privacidad')); ?>">Aviso de Privacidad</a>
                    <a href="<?php echo e(url('/terminos')); ?>">Términos de Servicio</a>
                    <a href="<?php echo e(url('/legal/view/consentimiento_datos_sensibles')); ?>">Protección de Datos</a>
                    <a href="<?php echo e(url('/registro')); ?>">Contacto</a>
                </nav>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\iris-escom\resources\views/index.blade.php ENDPATH**/ ?>