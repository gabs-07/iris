...
<body class="auth-body">
    ...
    <header class="main-header" id="mainHeader">
        <a href="<?php echo e(url('/')); ?>" class="logo iris-brand-logo"><img src="<?php echo e(asset('img/iris-logo.png')); ?>" alt="IRIS" class="brand-logo-image"></a>


        <div class="header-actions">
            <a href="<?php echo e(url('/registro')); ?>" class="btn-nav-login">Crear cuenta</a>
            <a href="<?php echo e(url('/login')); ?>" class="btn-nav-register">Iniciar sesión</a>
        </div>
    ...
    <div class="mobile-menu" id="mobileMenu" aria-hidden="true">
        ...
        <div class="mobile-actions">
            <a href="<?php echo e(url('/login')); ?>" class="btn-primary">Iniciar sesión</a>
            <a href="<?php echo e(url('/registro')); ?>" class="btn-outline">Crear cuenta</a>
        </div>
    </div>
    ...
    <main class="login-wrapper">
        <div class="login-container animate-fade-up">
            ...
            <section class="login-form-section">
                ...
                <?php if($errors->any()): ?>
                    <div style="margin-bottom:18px; padding:14px; border-radius:14px; background:#fff1f2; color:#9f1239;"><?php echo e($errors->first()); ?></div>
                <?php endif; ?>
                <?php if(session('success')): ?>
                    <div style="margin-bottom:18px; padding:14px; border-radius:14px; background:#e0f2e9; color:#1e5a45;"><?php echo e(session('success')); ?></div>
                <?php endif; ?>
                ...
                <form class="login-form" action="<?php echo e(url('/login')); ?>" method="post" novalidate>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="input-group">
                        <div class="label-row">
                            ...
                            <a href="<?php echo e(url('/recuperar')); ?>" class="forgot-password">¿Olvidaste tu contraseña?</a>
                        </div>
                        <div class="input-wrapper">
                    ...
                    <p class="form-footer">
                        ¿No tienes cuenta? <a href="<?php echo e(url('/registro')); ?>">Regístrate gratis</a>
                    </p>
                    <p class="form-footer" style="margin-top:10px; font-size:.86rem; line-height:1.5;">
                        Al usar IRIS puedes consultar el <a href="<?php echo e(url('/legal/view/aviso_privacidad')); ?>" target="_blank">Aviso de Privacidad</a>,
                        los <a href="<?php echo e(url('/legal/view/terminos_condiciones')); ?>" target="_blank">Términos y Condiciones</a>
                        y el <a href="<?php echo e(url('/legal')); ?>" target="_blank">Centro Legal</a>.
                    </p>
                </form>
            </section>
        </div>
...
<?php /**PATH C:\laragon\www\iris-escom\resources\views/login.blade.php ENDPATH**/ ?>